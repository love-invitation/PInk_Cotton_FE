...
const MainLeftIntroduce = () => {
  return (
    <article className='flex justify-center items-end gap-[0.1rem] laptop:gap-[0.3rem] select-none py-[2rem]'>
      <div className='flex flex-col items-center gap-[3rem] w-[24rem] laptop:w-[30rem] h-[46.2rem] laptop:h-[57.7rem]'>
        <PhoneMockup
          width='100%'
          height='100%'
        >
      ...
      <div className='w-[6rem] laptop:w-[10rem] h-[7rem] laptop:h-[11.3rem]'>
        <LayerIcon />
      </div>
    </article>
  );

...
const TemplateItem = ({
  ...
  return (
    <figure className='w-[35rem] h-[61.5rem] flex flex-col items-center justify-center gap-[2.8rem] main_card_max:min-w-[17.7rem] main_card_max:w-[17.7rem] main_card_max:h-[37rem] main_card_max:gap-[2rem]'>
      <TemplateCard
        size='medium'
